    ...
    def authenticate(self, name, accountNumber):
        ...
        if accountNumber in self.savingsAccounts.keys():
            if self.savingsAccounts[accountNumber][0] == name:
                ...
                self.accountNumber = accountNumber    #ustawienie nr konta podanego przez usera jako atrybutu instancji, po pozytywnym zakonczeniu autentyfikacji, pozostałe metody klasy maga uzywac tego numeru w instancji jako zaufanego
                print()
                return True
            else:
